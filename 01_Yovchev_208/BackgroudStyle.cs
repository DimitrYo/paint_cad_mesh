...
namespace _01_Yovchev_208
{
    ...
    public partial class BackgroudStyle : Form
    {
        public Brush brush;

        #region Initialize and PaintEvent and Brush

        public BackgroudStyle(Brush fontbrush)
        {
            InitializeComponent();
        ...
        private void BackgroudStyle_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void linearGradient_CheckedChanged_1(object sender, EventArgs e)
        {
            ...
            {
                button4.Visible = true;
                button4.CenterColor = Color.White;
            }
        }
